    ...
    public class DeletePostAction
    {
        ...
        public DeletePostAction()
        {
            ContextOptions = new DbContextOptionsBuilder<CoreDbContext>()
                .UseInMemoryDatabase("TestDeletePostDatabase")
                .Options;
        ...
        [Fact(DisplayName = "Successfully Delete Post Should Return Ok Status Code (200)")]
        public async void SuccessfullyDeletePostShouldReturnOk()
        {
            //ARRANGE
